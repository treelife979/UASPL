...
def ResNet34(num_classes=10, in_channels=1):
    return ResNet(BasicBlock, [3,4,6,3], num_classes=num_classes, in_channels=in_channels) # “BasicBlock”

def ResNet50(num_classes=10, in_channels=1):
    return ResNet(Bottleneck, [3,4,6,3], num_classes=num_classes, in_channels=in_channels) # “Bottleneck”
